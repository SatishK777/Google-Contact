    ...
    <section className="contact-us" id="contact-section">
      <form id="contact" onSubmit={handleSubmit} className="bg-dark">
        ...
        <div className="section-heading">
          <h4 className="text-white">Edit Contact</h4>
        </div>
        <div>
        <button type="button" onClick={onClose} className="btn22 me-2 bg-white text-dark">
           X
          </button>
        </div>
        </div>
        ...
        <div className="inputField btn">
          ...
          <button type="submit" className="btn22 bg-white text-dark">
            Update
          </button>
        </div>
      </form>
